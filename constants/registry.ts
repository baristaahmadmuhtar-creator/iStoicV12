...
export const UI_REGISTRY = {
    ...
    CHAT_BTN_DELETE: 'UI_CHAT_BTN_DELETE', // Added
...
export const FN_REGISTRY = {
    ...
    CHAT_DELETE_SESSION: 'FN_CHAT_DELETE_SESSION', // Added
...
export const COMPLETE_UI_MAP: Record<UI_ID, UIMetadata> = {
    ...
    [UI_REGISTRY.CHAT_BTN_DELETE]: { label: 'Delete Thread', event: 'CLICK', fn: FN_REGISTRY.CHAT_DELETE_SESSION, desc: 'Delete Chat Session' }, // Added
