            ...
            ${isDictating 
                ...
                : pasteFlash
                    ...
                    : isFocused || isDragOver 
                        ? `${accentColor} ring-2 ${ringColor} shadow-[0_0_25px_rgba(var(--accent-rgb),0.15)]` 
      ...
      >
        ...
        <div className="relative px-3 pt-2 pb-2">
            <textarea
                ...
                placeholder={isDictating ? t.listening : (personaMode === 'hanisah' ? "Chat with Hanisah..." : "Query Stoic Logic...")}
